...
namespace SpecEdu.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260217130151_AddNotificationsAndConsents")]
    partial class AddNotificationsAndConsents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpecEdu.Domain.Entities.ConsultationEvent", b =>
                {
                    ...
                    b.HasIndex("ReminderSent", "StartTime")
                        .HasFilter("[ReminderMinutesBefore] IS NOT NULL AND [ReminderSent] = 0");

                    b.HasIndex("SchoolId", "StartTime");

                    b.HasIndex("SchoolId", "Status");

                    b.ToTable("ConsultationEvents", (string)null);
                });

            modelBuilder.Entity("SpecEdu.Domain.Entities.ConsultationParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ConsultationEventId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ConsultationEventId");

                    b.HasIndex("ResponseStatus");

                    b.HasIndex("UserId");

                    b.HasIndex("ConsultationEventId", "UserId");

                    b.HasIndex("NotificationSent", "ConsultationEventId");
            ...
            modelBuilder.Entity("SpecEdu.Domain.Entities.UserConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SpecEdu.Domain.Entities.ConsultationParticipant", b =>
                {
                    b.HasOne("SpecEdu.Domain.Entities.ConsultationEvent", "ConsultationEvent")
                        .WithMany("Participants")
                        .HasForeignKey("ConsultationEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
