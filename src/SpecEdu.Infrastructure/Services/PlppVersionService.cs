...
/// <summary>
/// Implementation of IPlppVersionService.
/// Handles PLPP version history management.
/// Czech: Implementace služby pro správu historie verzí PLPP
/// </summary>
public class PlppVersionService : IPlppVersionService
{
    ...
    public async Task<PlppVersionDto> RestoreVersionAsync(Guid versionId)
    {
        ...
        // Soft delete existing goals and evaluations
        ...
        // Restore evaluations from snapshot
