...
/// <summary>
/// Implementation of IDiaryService.
/// Handles diary entry CRUD operations and attachment management.
/// </summary>
public class DiaryService : IDiaryService
{
        ...
        DiaryVisibility? visibilityFilter = null)
    {
        ...
        // For parents, only show ParentVisible entries
        ...
        // Get unique author IDs and fetch names
    ...
    public async Task<bool> CanEditAsync(Guid entryId, string userId)
    {
        ...
        // Only the author can edit their entries
