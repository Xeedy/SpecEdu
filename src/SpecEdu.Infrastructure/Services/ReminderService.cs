...
/// <summary>
/// Implementation of IReminderService.
/// Handles reminder CRUD operations and status updates.
/// </summary>
public class ReminderService : IReminderService
{
    ...
    /// <summary>
    /// Default lead time before due date to send notification.
    /// </summary>
    ...
    public async Task<ReminderDto> CreateAsync(Guid studentId, string title, DateTime dueDate, string? description = null)
    {
        ...
        // If notification date is in the past, set to now
    ...
    public async Task<bool> MarkAsFailedAsync(Guid id, string error)
    {
        ...
        // Reset to pending if retry count allows
