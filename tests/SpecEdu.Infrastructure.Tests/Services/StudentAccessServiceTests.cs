...
/// <summary>
/// Tests for StudentAccessService - the core access control service.
/// These tests are critical for ensuring relationship-based access control works correctly.
/// </summary>
public class StudentAccessServiceTests : IDisposable
{
    ...
    public async Task CanAccessStudentAsync_AdminUser_ReturnsFullAccess()
    {
        ...
        var adminUser = new ApplicationUser
        {
            ...
            SchoolId = null // Admin is not tied to a school
        };
    ...
    public async Task CanAccessStudentAsync_ParentWithGuardianLink_ReturnsReadOnlyAccess()
    {
        ...
        // Assert
        result.CanAccess.Should().BeTrue();
        result.CanEdit.Should().BeFalse(); // Parents have read-only access
